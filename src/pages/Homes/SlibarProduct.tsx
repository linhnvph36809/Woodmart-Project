...
const SlibarProduct = () => {
  return (
    <div className="relative furniture-collection">
      ...
      <div className="next absolute top-1/2 -right-5 z-10 translate-x-[30px] opacity-0 
      transtion-all duration-200 ease-linear">
        <svg
          ...
          strokeWidth={1.5}
          stroke="currentColor"
          className="w-8 h-8 text-color-black hover:text-[#777]"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
      ...
      <div className="pre absolute top-1/2 -left-10 z-10 -translate-x-[30px] opacity-0 
      transtion-all duration-200 ease-linear">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
